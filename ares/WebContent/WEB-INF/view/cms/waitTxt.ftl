...
<body>
    ...
    <div class="pagin">
    	<@lq.page   rows="${pagemodelcx.rows}" url="/ares/txt/select" cpage="${pagemodelcx.cpage}"  pageSize="8"  totalpage="${pagemodelcx.totalpage}"/>
    </div>
