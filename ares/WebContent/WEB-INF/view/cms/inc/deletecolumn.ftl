   <script language="JavaScript" src="/ares/static_hou/js/jquery.js"></script>
		<script language="JavaScript">
			...
			if(obj.options[obj.options.selectedIndex].value==""||name.length==0||parentid.length==0||status.length==0||keyword.length==0||desc.length==0||title.length==0){
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">在这里，您可以根据您的需求，删除栏目！</h3><h3 id="null"style="color:red;display:none;">(请完善表单内容后提交)</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="/ares/deletecolumn/delete" method="post" onsubmit="return CheckForm(document.all.id)" name="form1">
                                                <table width="100%" class="cont">
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td colspan="3"><input class="btn" style="width:110px;margin-left:470px;margin-top:150px;" type="submit" value="确定删除" /></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </table>
                                            </form>
