   ...
   <script language="JavaScript" src="/ares/static_hou/js/jquery.js"></script>
		<script language="JavaScript">
			...
			if(name.length==0||parentid=="a"||keyword.length==0||desc.length==0||title.length==0){
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="/ares/column/insert" method="post" onsubmit="return CheckForm()" name="form1">
                                                <table width="100%" class="cont">
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td colspan="3"><input class="btn" style="width:70px;" type="submit" value="确定添加" /></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </table>
                                            </form>
