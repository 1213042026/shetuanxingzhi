...
<body>
        ...
        <tbody>
        	<#list pagemodel.list  as tst>
		        ...
		        <td>
			        ...
			        <a href="javascript:void(0)" class="tablelink" onclick="if(confirm('确定删除么？')){location.href='/ares/txt/deleteTxtByid?id=${tst['id']}'; return true}" > 删除</a>
    ...
    <div class="pagin">
    	<@lq.page   rows="${pagemodel.rows}" url="/ares/txt/select" cpage="${pagemodel.cpage}"  pageSize="8"  totalpage="${pagemodel.totalpage}"/>
    </div>
