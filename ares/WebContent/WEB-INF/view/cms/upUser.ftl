...
<html>
	<head>
		...
		.placeul li{float:left; line-height:40px; padding-left:7px; padding-right:12px; background:url(/ares/static_hou/img/tu.jpg) no-repeat right;list-style: none;}
	...
	<div class="form-div">
        <form id="reg-form" action="/ares/user/updateUser?id=${userms['id']}" method="post">
            <table>
                <tr>
                    <td>账号</td>
                    <td><input name="uid" type="text" id="uid" placeholder="${userms['cms_user_uname']}"
                ...
                <tr>
                    <td>密码</td>
                    <td><input name="psw1" type="password" id="psw1" placeholder="请输入新密码"
                ...
                <tr>
                    <td>email</td>
                    <td><input name="email" type="text" id="email" placeholder="${userms['cms_user_email']}"
                ...
                <tr>
                    <td>昵称</td>
                    <td><input name="nickname" type="text" id="nickname" placeholder="${userms['cms_user_nickname']}"
                ...
                <tr>
                    ...
                    <td style="text-align: left;">
                        ...
                        <input name="sex" type="radio" id="sex-2" value="0" class="css-checkbox" style="margin-left: 20px;margin-right: 5px;">
                        	女
           	        </td>
                </tr>
                 <tr>
                    <td>电话</td>
                    <td><input name="tel" type="text" id="tel"  placeholder="${userms['cms_user_tel']}"
                 ...
                 <tr>
                    <td>QQ</td>
                    <td><input name="QQ" type="text" id="QQ" placeholder="${userms['cms_user_qq']}"
            ...
            <div class="buttons" >
                <input value="修改" type="submit" style="margin-left: 151px;">
            </div>
