...
<body>
    ...
    <div class="maintj">  
	    <div class="welinfo">
		    <b><a href="/ares/user/selectuserImf?id=${loginUser['id']}" target="rightFrame">${loginUser['cms_user_nickname']}</a> 您好，欢迎登陆！</b>
    ...
    <div class="listtitle"><a href="/ares/work/selectWait" class="more1">更多</a>待确认文章</div>    
